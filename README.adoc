...
:experimental:
:url-github: https://github.com/hyperpolymath/recon-silly-ation
:url-gitlab: https://gitlab.com/hyperpolymath/recon-silly-ation
:url-bitbucket: https://bitbucket.org/hyperpolymath/recon-silly-ation
:url-codeberg: https://codeberg.org/hyperpolymath/recon-silly-ation

Reconciliation with humor-based conflict resolution
...
recon-silly-ation is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
